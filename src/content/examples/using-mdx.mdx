...
pubDate: 'Jun 01 2024'
heroImage: '@/assets/example/blog-placeholder-5.jpg'
examplePage: true
tags: ['MDX']
---

import Image from '@/components/Image.astro';
import exampleImage from '@/assets/example/blog-placeholder-about.jpg';
...
When you open this page in the browser, you should see the image below.

<Image
	src={exampleImage}
	alt="Example image in MDX"
